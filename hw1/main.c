...
int main(int argc, char* argv[]) {
  ...
  if (rabbit_breed_searched)
    printf("I found %s breed with %i rabbits.\n", rabbit_breed_searched->breed,
           rabbit_breed_searched->count);
  else
    printf("I don't found the rabbit D:\n");
  ...
  printf(
      "I will print the rabbits sorted by the cuantity of rabbits in each "
      "breed\n");
